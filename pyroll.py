...
# Mogaji Olayinka                                Date : 07/29/2019
#---------------------------------------------------------------------
## PyPoll
######################################################################
...
pyroll = os.path.join("cwkdir","C:/Data/molayink/Documents/GitHub/cu-brk-data-pt-07-2019-u-c/02-Homeworks/03-Python/Instructions/PyPoll/Resources","election_data.csv")
